...
В этом семестре — зачёт (для 504 группы).

В следующем семестре курс продолжится на английском языке под названием «Математические модели программ и языков программирования», по этому курсу будет экзамен.
