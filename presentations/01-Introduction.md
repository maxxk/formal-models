...
Я — **Максим Александрович Кривчиков**, к.ф.-м.н., н.с. МГУ имени М.&nbsp;В.&nbsp;Ломоносова
...
В следующем семестре  — практические вопросы:
...
Первый семестр:
- CMU (US) [15-819 Homotopy Type Theory](http://www.cs.cmu.edu/~rwh/courses/hott/) — достаточно похоже на программу этого семестра
...
тестирование на основе спецификации входных данных:
  ...
  - [American Fuzzy Lop](http://lcamtuf.coredump.cx/afl/), использует генетические алгоритмы для автоматического подбора наборов входных данных, обеспечивающих максимальное покрытие целевого кода. [Пример использования](https://josephg.com/blog/bug-hunting-with-american-fuzzy-lop/)
...
- основные модели — автоматы и машина Тьюринга, λ-исчисление, частично-рекурсивные функции, нормальные алгорифмы Маркова
