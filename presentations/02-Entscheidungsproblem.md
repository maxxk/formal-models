...
Конструктивизм: закон исключённого третьего с точки зрения конструктивизма давал бы аппарат разрешения любых утверждений, а такой аппарат (забегая вперёд) построить нельзя.
...
Для бесконечных семейста независима от утверждений теории множеств.
...
В более широком смысле *задача разрешения* некоторого, возможно параметризованного, утверждения — это задача построения машины Тьюринга, которая принимает на вход параметр и всегда останавливается: со значением `0`, если утверждение неверно для параметра, или со значением `1`, если утверждение верно для параметра.
...
Интерактивная реализация в браузере:
...
**Корректность алгоритма** — свойство, согласно которому для любого входа алгоритм завершается и возвращает решение задачи для этого входа (или, скажем, некоторый признак ошибки, если алгоритм неприменим к заданному входу). Т.е. «программа должна выводить правильный ответ, никогда не падать и никодга не зависать».
...
**Конечный автомат** (finite automaton) — это четвёрка:

- Q — множество состояний

- I, O — входной и выходной алфавит
...
# Задачи
**Задача 2.4а. \*** 
~ Реализовать в интерпретаторе машины Тьюринга сравнение двух унарных чисел (на входе — два унарных числа, на выходе — 0, если первое больше второго и 1 — если второе больше первого).
**Задача 2.4б. \*\*** 
