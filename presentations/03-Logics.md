...
## Формальные системы. Полнота и непротиворечивость. Теоремы Гёделя о неполноте. Неразрешимые задачи для формальных систем.
...
Вариант 1. Запишем проблему останова в терминах арифметики.
Вариант 2. Разрешение G~F~.
